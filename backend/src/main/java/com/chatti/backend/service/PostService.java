package com.chatti.backend.service;

import com.chatti.backend.dto.CommentRequest;
import com.chatti.backend.dto.CommentResponse;
import com.chatti.backend.dto.PostRequest;
import com.chatti.backend.dto.PostResponse;
import com.chatti.backend.model.Comment;
import com.chatti.backend.model.Post;
import com.chatti.backend.model.User;
import com.chatti.backend.repository.CommentRepository;
import com.chatti.backend.repository.PostRepository;
import com.chatti.backend.repository.UserRepository;
import com.chatti.backend.util.HtmlSanitizer;
...
public class PostService {
    ...
    public void deletePost(Long id, String username) {
        ...
        User requester = userRepository.findByUsername(username)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "User not found"));
        if (!post.getUser().getUsername().equals(username) && 
            requester.getRole() != com.chatti.backend.model.Role.ADMIN && 
            requester.getRole() != com.chatti.backend.model.Role.MANAGER) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Unauthorized");
        }
